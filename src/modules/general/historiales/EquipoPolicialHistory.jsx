...
import { getHistorialEquipoPolicialById, postEditarHistorialById, deleteHistorialById } from '../../../services/historialBienesService'
...
const EquipoPolicialHistory = () => {
    ...
    const traerData = () => {
        ...
        getHistorialEquipoPolicialById(idUrl).then(rpta => {
            setData(rpta.data);
            setCargando(false)
        })
    }
                                                    ...
                                                    <div className="col-md-12">
                                                        ...
                                                        {data.is_internado ? (<>
                                                            ...
                                                            <div className="border">
                                                                ...
                                                                <div className="mt-1">Acta de Entrega y Recepción: {internamiento?.acta ? (<>
                                                                    <div className="d-inline-block pointer" onClick={() =>
                                                                ...
                                                                <div className="mt-1">Oficio de Regularización: {internamiento?.oficio ? (<>
                                                                    <div className="d-inline-block pointer" onClick={() =>
...
export default EquipoPolicialHistory
