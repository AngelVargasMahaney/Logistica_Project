...
import { getInfoBienesDirinById } from '../../../services/bienesPublicosService';

const PublicViewBienesDirin = () => {
    const TITULO = "Bienes Dirin";
    ...
    const traerData = () => {
        ...
        getInfoBienesDirinById(idUrl).then(rpta => {
            setData(rpta.data);
            setCargando(false)
        })
    }
                            ...
                            <div className="col">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <p>denominacion: {data.denominacion} </p>
                                        <p>correl: {data.correl} </p>
...
export default PublicViewBienesDirin
